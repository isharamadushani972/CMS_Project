...
class __TwigTemplate_2e3714ac552f4d05048fcb68f5079b4ee67a0ffaa36e4bc21d73a9628ec8e3e5 extends \Twig\Template
{
...
($context["gantry"] ?? null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/atoms.html.twig", "C:\\xampp\\htdocs\\ishara\\administrator\\components\\com_gantry5\\templates\\pages\\configurations\\page\\atoms.html.twig");
    }
}
