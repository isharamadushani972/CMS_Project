...
class JSNPBShortcodeVideo extends IG_Pb_Element {
	...
	public function backend_element_assets() {
		...
		JSNPagebuilderHelpersFunctions::print_asset_tag(JSNPB_ELEMENT_URL . '/video/assets/css/video_backend.css', 'css');
	...
	public function element_config() {
		...
		$this->config['exception'] = array(
			'data-modal-title' => JText::_('JSN_PAGEBUILDER_ELEMENT_MODAL_TITLE_PB_VIDEO')
		);
	}
